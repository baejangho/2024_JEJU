...
echo_and_run cd "/home/jbae_lab/2024_JEJU_ws/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/jbae_lab/2024_JEJU_ws/src/rosserial/rosserial_python/setup.py" \
     \
    build --build-base "/home/jbae_lab/2024_JEJU_ws/build/rosserial/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
