...
def image_callback(img_msg):
    global last_line_center_left, last_line_center_right
    ...
    angular_z = (center_x - float(line_center_left + line_center_right) / 2) / 300
    ...
    # 결과 이미지에 원을 그리기
    cv2.circle(cv_image, (line_center_left, height - roi_height // 2), 10, (0, 0, 255), -1)
    cv2.circle(cv_image, (line_center_right, height - roi_height // 2), 10, (255, 0, 0), -1)
    cv2.circle(edges, (line_center_left, height - roi_height // 2), 10, (255, 255, 255), -1)
    cv2.circle(edges, (line_center_right, height - roi_height // 2), 10, (255, 255, 255), -1)
